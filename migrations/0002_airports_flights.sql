...
INSERT OR IGNORE INTO airports (id, iata_code, icao_code, name, city, country, latitude, longitude, timezone) VALUES
  ...
  ('nnt', 'NTE', 'LFRS', 'Aéroport Nantes Atlantique', 'Nantes', 'France', 47.1532, -1.6108, 'Europe/Paris'),
  ...
  ('nte', 'NTE', 'LFRS', 'Aéroport de Nantes Atlantique', 'Nantes', 'France', 47.1532, -1.6108, 'Europe/Paris');
